...
class StudentController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        // return redirect('/student-manage')->back()->with('message', 'Student Updated Successfully');
        return redirect()->route('student-manage')->with(['message' => 'Student Updated Successfully']);
    }
}
